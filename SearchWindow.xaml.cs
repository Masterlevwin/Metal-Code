        ...
        private string Get_Offers(string? message = null)
        {
            ...
            if (isAvalaible)
            {
                try
                {
                    ...
                    {
                        var offers = _man.Offers.Where(o => (o.N is not null && o.N.Contains(Search, StringComparison.OrdinalIgnoreCase))
                                            || (o.Company is not null && o.Company.Contains(Search, StringComparison.OrdinalIgnoreCase))).ToList();
